...
describe 'The users feature' do
  ...
  it 'should list all users on index' do
    user = User.create(username: 'Sasaki Kojiro', password: "foo", password_confirmation: "foo")
    visit users_path
    expect(page).to have_content('Sasaki Kojiro')
  end

  it "should allow users to create a user" do
    user = User.create(username: 'Sasuke Kojiro', password: "foo", password_confirmation: "foo")
  ...
  it "should allow a user to delete a user" do
    user = User.create(username: "foo", password: "foo", password_confirmation: "foo")
    visit user_path(user)
    click_on "Delete"
